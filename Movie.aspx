...
<body>
   ...
   <a href="Registration.aspx" style=" text-decoration:none; color:White;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register Now</a></div>
    ...
    <p style="color:White;font-family:Microsoft JhengHei;font-size:70px;text-shadow:10px 10px 20px grey;">Welcome <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></p>
      ...
      <table style="width: 62%; margin-left:180px; margin-top:10px; margin-bottom:10px">
              <tr>
                  <td>
                      ...
                      <asp:Button ID="Button2" runat="server" CssClass="btn" Text="Logout" 
...
Coming Soon : 6-5=2, Anegan, Beauty And The Beast, Elizabeth Ekadashi, Enakkal Oruvan
    ...
    <p><a href="index.aspx" style=" color:White; text-decoration:none;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'"> Home </a>   |   
     ...
     <a href="#" style=" color:White; text-decoration:none;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">  Now Showing   </a> |   
     <a href="#" style=" color:White; text-decoration:none;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'"> Coming Soon </a>  |    
     <a href="#" style=" color:White; text-decoration:none;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Contact us</a>
</p>
