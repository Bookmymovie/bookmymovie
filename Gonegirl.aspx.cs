...
public partial class Gonegirl : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select * from Gonegirl", con);
        ...
        Response.Redirect("Gonegirl1.aspx");
    }
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Gonegirl2.aspx");
    }
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Gonegirl3.aspx");
    }
}