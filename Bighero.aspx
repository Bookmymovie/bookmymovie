<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bighero.aspx.cs" Inherits="Bighero" %>
...
<body>
   ...
   <a href="Registration.aspx" style=" text-decoration:none; color:White;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register Now</a></div>
	...
	<div class="ws_images">
<span><img src="data3/images/3961476bighero6characterrollouthiro.jpg" alt="3961476-big-hero-6-character-rollout-hiro" title="" id="wows0"/></span>
<span><img src="data3/images/big_hero_6_logo_2.jpg" alt="Big_Hero_6_Logo_2" title="" id="wows1"/></span>
<span><img src="data3/images/bighero6.jpg" alt="BigHero6" title="" id="wows2"/></span>
<span><img src="data3/images/bighero6_0.jpg" alt="big-hero-6" title="" id="wows3"/></span>
<span><img src="data3/images/bighero6movie.jpg" alt="big-hero-6-movie" title="" id="wows4"/></span>
<span><img src="data3/images/bighero6movieimage.jpg" alt="Big-Hero-6-Movie-Image" title="" id="wows5"/></span>
</div>
<div class="ws_bullets"><div>
<a href="#wows0" title="3961476-big-hero-6-character-rollout-hiro"><img src="data3/tooltips/3961476bighero6characterrollouthiro.jpg" alt="3961476-big-hero-6-character-rollout-hiro"/>1</a>
<a href="#wows1" title="Big_Hero_6_Logo_2"><img src="data3/tooltips/big_hero_6_logo_2.jpg" alt="Big_Hero_6_Logo_2"/>2</a>
<a href="#wows2" title="BigHero6"><img src="data3/tooltips/bighero6.jpg" alt="BigHero6"/>3</a>
<a href="#wows3" title="big-hero-6"><img src="data3/tooltips/bighero6_0.jpg" alt="big-hero-6"/>4</a>
<a href="#wows4" title="big-hero-6-movie"><img src="data3/tooltips/bighero6movie.jpg" alt="big-hero-6-movie"/>5</a>
<a href="#wows5" title="Big-Hero-6-Movie-Image"><img src="data3/tooltips/bighero6movieimage.jpg" alt="Big-Hero-6-Movie-Image"/>6</a>
</div></div>
    ...
    <div class="ticket"><a href="Bighero.aspx" style=" color:White; text-decoration:none; margin-left:40px;">Add To Wishlist</a></div>
              ...
              <tr>
                  ...
                  <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="#FFFFCC" 
                      onclick="LinkButton1_Click"><h5>1:00 P.M.</h5></asp:LinkButton>
                  </th></td>
    </tr>
    <tr>
                  <td align="left" class="style1"><h5>Inox: CC1</h5><th align="left">
                  <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="#FFFFCC" 
                      onclick="LinkButton2_Click"><h5>12:00 P.M.</h5></asp:LinkButton>
                  </th></td>
    </tr>
    <tr>
                  <td align=left class="style1"><h5>Inox: Swabhumi</h5><th align="left">
