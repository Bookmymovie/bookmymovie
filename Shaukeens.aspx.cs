...
public partial class Shaukeens : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select * from Shaukeens", con);
        ...
        Response.Redirect("Shaukeens1.aspx");
    }
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Shaukeens2.aspx");
    }
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Shaukeens3.aspx");
    }
}