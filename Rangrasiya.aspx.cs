...
public partial class Rangrasiya : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select * from Rangrasiya", con);
        ...
        Response.Redirect("Rangrasiya1.aspx");
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Rangrasiya2.aspx");
    }
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Rangrasiya3.aspx");
    }
}