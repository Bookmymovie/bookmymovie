...
public partial class Intersteller : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select * from interstellar", con);
        ...
        Response.Redirect("Interstellar1.aspx");
    }
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Interstellar2.aspx");
    }
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Interstellar3.aspx");
    }
}