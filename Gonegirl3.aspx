<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gonegirl3.aspx.cs" Inherits="Gonegirl3" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Booking Of Gonegirl</title>
...
<body>
   ...
   <a href="Registration.aspx" style=" text-decoration:none; color:White;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register Now</a></div>
    ...
    <div class="logo"><img src="images/logo.png" alt="" width="350px" height="82px"/></div>
