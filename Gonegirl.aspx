<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gonegirl.aspx.cs" Inherits="Gonegirl" %>
...
<form id="form1" runat="server">
   ...
   <a href="Registration.aspx" style=" text-decoration:none; color:White;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register Now</a></div>
	...
	<div class="ws_images">
<span><img src="data7/images/dzi18.jpg" alt="dziś-18" title="" id="wows0"/></span>
<span><img src="data7/images/gonegirl.jpg" alt="GoneGirl" title="" id="wows1"/></span>
<span><img src="data7/images/gonegirl_0.jpg" alt="Gone-Girl" title="" id="wows2"/></span>
<span><img src="data7/images/gonegirlfincerspecialshoot.jpg" alt="GoneGirlFincerSpecialShoot" title="" id="wows3"/></span>
</div>
<div class="ws_bullets"><div>
<a href="#wows0" title="dziś-18"><img src="data7/tooltips/dzi18.jpg" alt="dziś-18"/>1</a>
<a href="#wows1" title="GoneGirl"><img src="data7/tooltips/gonegirl.jpg" alt="GoneGirl"/>2</a>
<a href="#wows2" title="Gone-Girl"><img src="data7/tooltips/gonegirl_0.jpg" alt="Gone-Girl"/>3</a>
<a href="#wows3" title="GoneGirlFincerSpecialShoot"><img src="data7/tooltips/gonegirlfincerspecialshoot.jpg" alt="GoneGirlFincerSpecialShoot"/>4</a>
</div></div>
    ...
    <div class="ticket"><a href="Bighero.aspx" style=" color:White; text-decoration:none; margin-left:40px;">Add To Wishlist</a></div>
              ...
              <tr>
                  ...
                  <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="#FFFFCC" 
                      onclick="LinkButton1_Click"><h5>2:20 P.M.</h5></asp:LinkButton>
                  </th></td>
    </tr>
    <tr>
                  <td align="left" class="style1"><h5>Inox City Center Saltlake</h5><th align="left">
                  <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="#FFFFCC" 
                      onclick="LinkButton2_Click"><h5>12:50 P.M.</h5></asp:LinkButton>
                  </th></td>
    </tr>
    <tr>
                  <td align=left class="style1"><h5>Inox Rajarhat</h5><th align="left">
                  <asp:LinkButton ID="LinkButton3" runat="server" ForeColor="#FFFFCC" 
                      onclick="LinkButton3_Click"><h5>8:30 P.M.</h5></asp:LinkButton>
                  </th></td>
    </tr>
    </table>
    </div>
