<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Newcoming1.aspx.cs" Inherits="Newcoming1" %>
...
<body>
   ...
   <a href="Registration.aspx" style=" text-decoration:none; color:White;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register Now</a></div>
    ...
    <tr><td><img src="images/6%205%202%20Hindi%20Movie%20Posters%20(1).jpg" height="500px" width="500px" /></td></tr>
    <tr>
    <td>
    <div class="ticket"><a href="#" style=" color:White; text-decoration:none; margin-left:40px;">Add To Wishlist</a></div>
    </td>
    </tr>
    </table>
    </div>
