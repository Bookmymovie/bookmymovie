...
public partial class Chotushkon : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select * from Chotushkon", con);
        ...
        Response.Redirect("Chotushkon1.aspx");
    }
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Chotushkon2.aspx");
    }
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("showtime", time);
        Session.Add("movieprice", price);
        Response.Redirect("Chotushkon3.aspx");
    }
}