<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Newcoming2.aspx.cs" Inherits="Newcoming2" %>
...
<body>
   ...
   <a href="Registration.aspx" style=" text-decoration:none; color:White;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register Now</a></div>
    ...
    <tr><td><img src="images/BeautyAndTheBeast2014MoviePoster.jpg" height="500px" width="500px" /></td></tr>
    <tr>
    <td>
