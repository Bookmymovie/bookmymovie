<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Newcoming4.aspx.cs" Inherits="Newcoming4" %>
...
<body>
   ...
   <a href="Registration.aspx" style=" text-decoration:none; color:White;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register Now</a></div>
    ...
    <tr><td><img src="images/saif-ali-khan-happy-ending.jpg" height="550px" width="450px" /></td></tr>
    <tr>
    <td>
