<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Interstellar2.aspx.cs" Inherits="Interstellar2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>The Interstellar Booking</title>
...
<body>
   ...
   <a href="Registration.aspx" style=" text-decoration:none; color:White;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register Now</a></div>
        ...
        <table style="width: 30%; margin-left:425px; color:White;">
            ...
            <tr>
                <td colspan="2"align="center">
                    ...
                    <img src="images/paradisecinema.jpg" height="320px" width="1000px" style="margin-left:200px;" />
        </div>
    ...
    <p><a href="index.aspx" style=" color:White; text-decoration:none;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'"> Home </a>   |   
     ...
     <a href="Move.aspx" style=" color:White; text-decoration:none;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'"> Coming Soon </a>  |    
